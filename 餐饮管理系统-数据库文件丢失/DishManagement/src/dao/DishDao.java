...
public class DishDao {
	 ...
	 * 管理员添加菜品,测试通过
	 */
	public void addDish(String dish_name,double dish_price,
			String dish_description,String dish_image) {
		Jdbc j=new Jdbc();
		Connection con=j.getConnection();
		String sql = "insert into dish(dish_name,dish_price,dish_description,dish_image)"
				+ "values(?,?,?,?)";
