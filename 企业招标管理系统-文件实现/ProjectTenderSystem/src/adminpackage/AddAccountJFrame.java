...
public class AddAccountJFrame extends JFrame implements ActionListener{
	...
	public AddAccountJFrame(Map<String, Staff> staffs, File stafffile) {
		super("Add Staff JFrame");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Confirm")) {
			if(!this.nametext.getText().equals("")
				...
				if(this.map.get(staff.getStaffnumber()) == null) {
					...
					JOptionPane.showMessageDialog(null, "The Staff Has Exists,Please Add again.");
				}
			}else {
