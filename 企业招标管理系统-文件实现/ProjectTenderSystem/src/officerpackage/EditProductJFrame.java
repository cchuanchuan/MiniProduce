...
public class EditProductJFrame extends JFrame implements ActionListener {
	...
	public EditProductJFrame(Map<String, Product> products, Map<String, ProductType> producttype,
			Map<String, ProductMaterial> productmaterials, File productfile,String productstr) {
		...
		this.typebox.setSelectedItem(product.getProducttype().getTypenumber());
		...
		this.materialbox.setSelectedItem(product.getProductmaterial().getMaterialnumber());
