...
public class AddTenderJFrame extends JFrame implements ActionListener {
	...
	public AddTenderJFrame(Map<String, Tender> tenders, Map<String, Product> products, File tenderfile) {
		super("Add Tender JFrame");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Confirm")) {
			...
			if(!this.nametext.getText().equals("")
				...
				if(this.tendermap.get(this.numbertext.getText()) != null) {
					JOptionPane.showMessageDialog(null, "The Tender Has Exists,Please Add again.");
					return;
				}
				if(this.tendermap.get(this.numbertext) == null) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "Add Success : "+tender);
						this.dispose();
