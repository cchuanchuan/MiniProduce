...
public class AddTypeJFrame extends JFrame implements ActionListener {
	...
	public AddTypeJFrame(Map<String, ProductType> producttype, File producttypefile) {
		super("Add Type JFrame");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Confirm")) {
			if(!this.nametext.getText().equals("")
				...
				if(this.map.get(producttype.getTypenumber()) ==null) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "Add Success:"+producttype);
						this.dispose();
					...
					JOptionPane.showMessageDialog(null, "The Type Has Exists,Please Add again.");
				}
